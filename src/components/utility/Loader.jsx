...
export const Loader = ({ onLoadingComplete }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 bg-gradient-to-br from-slate-100 to-slate-200 flex items-center justify-center">
      <div className="text-center space-y-8">
        ...
        <div className="relative">
          {/* Board Shadow */}
          <div className="absolute top-2 left-2 w-80 h-48 bg-slate-400/20 rounded-lg blur-sm"></div>
          
          {/* Main PVC Board */}
          <div className="relative w-80 h-48 bg-gradient-to-br from-white via-slate-50 to-slate-100 rounded-lg border-2 border-slate-300 shadow-xl overflow-hidden opacity-0 animate-[scaleIn_0.8s_ease-out_0.2s_forwards]">
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              ...
              >
                <g transform="translate(0, 266) scale(0.1, -0.1)">
                  {/* Border frame */}
                  <path
                    d="M85 2558 c-3 -7 -4 -564 -3 -1238 l3 -1225 5028 -3 5027 -2 -1 22 c-1 17 -2 19 -6 6 -4 -17 -252 -18 -5024 -18 l-5019 0 0 1230 0 1230 5019 0 c4772 0 5020 -1 5025 -17 4 -14 4 -14 3 2 -2 20 -11 20 -5025 23 -4013 2 -5024 0 -5027 -10z"
                    fill="none"
                    stroke="#64748b"
                    strokeWidth="3"
                    strokeLinecap="round"
                    ...
                    pathLength="1"
                    strokeDasharray="1"
                    strokeDashoffset={progress > 2 ? 0 : 1 - (progress / 2)}
                    className={`transition-all duration-500 ${progress > 1 ? 'opacity-60' : 'opacity-0'}`}
                  />
                  ...
                  <path
                    ...
                    className={`transition-all duration-500 ${progress > 6 ? 'opacity-100' : 'opacity-0'}`}
                  />
                  ...
                  <path
                    ...
                    className={`transition-all duration-400 ${progress > 10 ? 'opacity-100' : 'opacity-0'}`}
                  />
                  ...
                  <path
                    ...
                    className={`transition-all duration-400 ${progress > 14 ? 'opacity-100' : 'opacity-0'}`}
                  />
                  ...
                  <path
                    ...
                    className={`transition-all duration-400 ${progress > 18 ? 'opacity-100' : 'opacity-0'}`}
                  />
                  ...
                  <path
                    ...
                    className={`transition-all duration-400 ${progress > 22 ? 'opacity-100' : 'opacity-0'}`}
                  />
                  ...
                  <path
                    ...
                    className={`transition-all duration-400 ${progress > 26 ? 'opacity-100' : 'opacity-0'}`}
                  />
                  ...
                  <path
                    ...
                    className={`transition-all duration-400 ${progress > 30 ? 'opacity-100' : 'opacity-0'}`}
                  />
                  ...
                  <path
                    ...
                    className={`transition-all duration-600 ${progress > 35 ? 'opacity-100' : 'opacity-0'}`}
                  />
        ...
        {/* Progress Info */}
        <div className="space-y-3 opacity-0 animate-[fadeIn_0.6s_ease-out_0.3s_forwards]">
          ...
          <div className="w-80 h-2 bg-slate-300 rounded-full overflow-hidden">
            <div
              className="h-full bg-gradient-to-r from-blue-500 to-teal-500 rounded-full relative transition-all duration-300"
