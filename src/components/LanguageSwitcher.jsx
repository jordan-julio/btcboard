  ...
  return (
    <div className="relative" ref={dropdownRef}>
      <button 
        ...
        className="flex items-center space-x-2 px-3 py-2 rounded-lg hover:bg-gray-100 transition-colors disabled:opacity-50 focus:outline-none border-2 border-blue-500" 
        disabled={isPending}
      ...
      {isOpen && (
        <div className="absolute left-0 top-full mt-2 w-32 bg-white rounded-lg shadow-lg border z-50 animate-in fade-in-0 zoom-in-95 duration-100">
          <button
            onClick={() => switchLanguage('en')}
            disabled={isPending}
            className={`w-full px-4 py-2 text-left hover:bg-gray-50 focus:bg-gray-50 rounded-t-lg transition-colors disabled:opacity-50 focus:outline-none ${
          ...
          <button
            ...
            disabled={isPending}
            className={`w-full px-4 py-2 text-left hover:bg-gray-50 focus:bg-gray-50 rounded-b-lg transition-colors disabled:opacity-50 focus:outline-none ${
